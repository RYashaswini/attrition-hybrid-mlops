...
PROMOTION_COLUMNS = [
    "department", "current_designation", "tenure_months",
    "months_since_last_promotion", "performance_rating",
    "avg_performance_rating_last_2yrs", "project_completion_rate",
    "training_hours_completed", "peer_review_score", "manager_rating",
    "leadership_flag", "certifications_count",
]
